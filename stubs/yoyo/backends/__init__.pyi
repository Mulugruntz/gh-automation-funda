...
class DatabaseBackend:
    ...
    def transaction(
        self, rollback_on_exit: bool = False
    ...
    def _insert_lock_row(
        self, pid: str, timeout: int, poll_interval: float = 0.5
    ) -> None: ...
    ...
    def apply_one(
        self, migration: Migration, force: bool = False, mark: bool = True
    ) -> None: ...
